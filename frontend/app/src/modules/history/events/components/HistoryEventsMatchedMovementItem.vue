...
import { HIGHLIGHT_CLASSES, type HighlightType } from '@/composables/history/events/use-history-events-filters';
...
<template>
  ...
  <div
    ...
    :class="[
      ...
      highlight && highlightType && HIGHLIGHT_CLASSES[highlightType],
    ]"
  >
