...
export function getDefaultFrontendLogLevel(): LogLevelNumbers {
...
export function mapToFrontendLogLevel(logLevel?: LogLevel): LogLevelNumbers {
  if (!logLevel)
...
function setLevel(loglevel?: LogLevel, persist = true): void {
