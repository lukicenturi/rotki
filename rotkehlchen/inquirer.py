...
class Inquirer:
    ...
    def _get_special_prices(
        ...
        """
        usd_found_prices, found_prices, assets_without_special_price = {}, {}, []
        eur_collection_assets: list[Asset] = []
        for from_asset in from_assets:
            if from_asset == A_BSQ:
        ...
        if len(eur_collection_assets) > 0:  # EURe collection assets are pegged to EUR
