...
def test_insert_into_addressbook(
    ...
    with db_addressbook.read_ctx(book_type) as cursor:
        ...
        assert_error_response(
            response=response,
            contained_in_msg='address "0x9531C059098e3d194fF87FebB587aB07B30B1306" and blockchain ETH already exists in the address book.',  # noqa: E501
...
def test_delete_addressbook(
    ...
    with db_addressbook.read_ctx(book_type) as cursor:
        ...
        assert_error_response(
            response=response,
            contained_in_msg='Addressbook entry with address "0x9D904063e7e120302a13C6820561940538a2Ad57" and blockchain None doesnt exist ',  # noqa: E501
            status_code=HTTPStatus.CONFLICT,
        )
